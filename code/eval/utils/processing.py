...
def evaluate_prediction(prediction: str, answer: str, dataset: str, question: str = "") -> float:
    ...
    if dataset == "geo3k" or dataset == "mmstar" or dataset == "mathvista" or dataset == "mathverse" or dataset == "mathvision" or dataset == "wemath"  or dataset == "emoset" or dataset == "webemo" or dataset == "emotion6":
